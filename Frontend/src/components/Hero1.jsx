...
const Hero1 = () => {
    return (
        <div className="flex flex-col items-center w-full h-auto overflow-hidden relative gap-12 flex-shrink-0">
            ...
            <div className="flex flex-col gap-6 w-full relative sm:flex-wrap justify-center items-center min-h-screen"> {/* Added min-h-screen */}
                <div className="flex flex-wrap gap-6 w-full justify-center items-center"> {/* Centered on both X and Y axis */}
                ...
                <div className="flex flex-wrap gap-6 w-full justify-center items-center">
                    <div className="flex flex-wrap w-full gap-4 justify-center items-center">
                        <div className=" sm:mt-4 flex-1 sm:flex-none sm:w-auto">
                            <BlogCard />
                        </div>
                        <div className="flex-1 sm:flex-none sm:w-auto">
                            <BlogCard />
