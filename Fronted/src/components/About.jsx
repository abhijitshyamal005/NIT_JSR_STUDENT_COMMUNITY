  ...
  return (
    <div className="w-full flex   flex-col items-center justify-center relative px-4 lg:px-8 xl:px-16">
      <div className="w-full flex flex-col lg:flex-row items-start gap-16">
        ...
        {/* Cards Section (with sticky behavior) */}
        <div className="w-full lg:w-1/2">
          <div className="sticky top-10 space-y-8 gap-3">
            <div className=" relative bg-gray-100 p-7 rounded-lg transform -rotate-2 hover:rotate-2 transition-transform duration-300 hover:scale-110">
            ...
            <div className="relative bg-[#f5d1b0] p-6 rounded-lg transform rotate-2 hover:-rotate-2 transition-transform duration-300 hover:scale-110">
            ...
            <div className="relative bg-gray-100 p-6 rounded-lg transform -rotate-2 hover:rotate-2 transition-transform duration-300 hover:scale-110">
